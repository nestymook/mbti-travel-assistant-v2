...
from src.services.restaurant_service import RestaurantService, RestaurantSearchError
from src.services.auth_middleware import create_authentication_middleware, AuthenticationHelper
...
def load_cognito_config() -> Dict[str, Any]:
    ...
    try:
        config_path = os.path.join(os.path.dirname(__file__), '..', 'config', 'cognito_config.json')
...
if __name__ == "__main__":
    ...
    if require_auth:
        try:
            from src.services.auth_service import TokenValidator
